...
class DateRange extends Field
{
    protected static $css = [
        '/vendor/daimakuai-admin/eonasdan-bootstrap-datetimepicker/build/css/bootstrap-datetimepicker.min.css',
    ];

    protected static $js = [
        '/vendor/daimakuai-admin/moment/min/moment-with-locales.min.js',
        '/vendor/daimakuai-admin/eonasdan-bootstrap-datetimepicker/build/js/bootstrap-datetimepicker.min.js',
    ];
