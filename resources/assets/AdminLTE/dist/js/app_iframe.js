...
var App = function () {
    ...
    var globalCssPath = 'dist/css/';

    var rememberTabs = false;
    ...
    return {
        ...
        setRememberTabs : function(value){
            rememberTabs = value;
        },

        getRememberTabs : function (){
            return rememberTabs;
        }
...
var addTabs = function (options) {
    ...
    if(App.getRememberTabs()){
        var tabs_cookies = new Array();
        ...
        if(have == false)
        {
            tabs_cookies.push(JSON.stringify(options));
        }

        $.cookie('tabs_cookies',tabs_cookies.join('||'), {  expires: 7,path: '/'} );
