...
<head>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="{{ admin_asset("/vendor/daimakuai-admin/AdminLTE/plugins/iCheck/square/blue.css") }}">
...
<!-- jQuery 2.1.4 -->
<script src="{{ admin_asset("/vendor/daimakuai-admin/AdminLTE/plugins/jQuery/jQuery-2.1.4.min.js")}} "></script>
<!-- Bootstrap 3.3.5 -->
<script src="{{ admin_asset("/vendor/daimakuai-admin/AdminLTE/bootstrap/js/bootstrap.min.js")}}"></script>
<!-- iCheck -->
<script src="{{ admin_asset("/vendor/daimakuai-admin/AdminLTE/plugins/iCheck/icheck.min.js")}}"></script>
<script>
  $(function () {
    $('input').iCheck({
