...
<head>
    ...
    <link rel="stylesheet" href="{{ asset("/packages/admin/AdminLTE/dist/css/skins/all-skins.min.css") }}">

    <!-- REQUIRED JS SCRIPTS -->

    <script src="{{ asset ("/packages/admin/AdminLTE/plugins/jQuery/jQuery-2.2.3.min.js") }}"></script>
    ...
    <script src="{{ asset ("/packages/admin/AdminLTE/plugins/fastclick/fastclick.js") }}"></script>
    <script src="{{ asset ("/packages/admin/AdminLTE/dist/js/app.js") }}"></script>

    <script src="{{ asset ("/packages/admin/AdminLTE/dist/js/app_iframe.js") }}"></script>
...
<body class="hold-transition fixed {{config('admin.skin')}} {{join(' ', config('admin.layout'))}}">
<div class="wrapper">
...
<!-- REQUIRED JS SCRIPTS -->
<script src="{{ asset ("/packages/admin/AdminLTE/dist/js/demo.js") }}"></script>
